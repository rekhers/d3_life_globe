 ...
 //how we're going to add points 
  ...
  var plane = svg.append("path")
    ...
    var route = svg.append("path")
      .datum({type: "LineString", coordinates: [72, -126] })
        .attr("class", "route")
         .attr("d", path);
...
if(lastCity){
    ...
    // var route = svg.append("path")
    //            .datum({type: "LineString", coordinates: [[cityCoords[lastCity].geometry.coordinates[0], cityCoords[lastCity].geometry.coordinates[1]], [cityCoords[currCity].geometry.coordinates[0], cityCoords[currCity].geometry.coordinates[1]]]})
    //            .attr("class", "route")
    //            .attr("d", path);
